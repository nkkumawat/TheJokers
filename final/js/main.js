...
$("#results").html(eval(str));
};

fn.gen = function(str,cmp) {
$.getJSON("response.php?request="+encodeURI(str)).done(function(data) {
$("#results").html(data.toString());
if(data=='404') $("#results").html("Please Share with me if you know the answer :<form action='insert.php' method='get' ><br/><input type='text' class='txtbox' style='font:24px Roboto;' name='ques' value='"+cmp+"' /><br/><br/><textarea class='txtbox' name='ans' style='font:24px Roboto;'  placeholder='Enter an answer' ></textarea><br/><input type='submit' />");
});
};
